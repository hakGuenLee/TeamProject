   ...
   <section>
      ...
      <div class="d-flex">
         <div id="imgArea">
            ...
            <c:if test="${dto.sub_img1 != null && dto.sub_img1 != ''}">
            <img id="subimg2" src="/resources/upload/${dto.sub_img1}" style="width:70px;height:70px">
            </c:if>
             <c:if test="${dto.sub_img2 != null && dto.sub_img2 != '' }">
...
<!--             <select class="w-100 border border-secondary rounded-1"  id="pqty" name="pqty">
            ...
            <a href="/userQna/prodQuestion?name=${dto.prod_nm}&no=${dto.prod_no}" class="btn btn-secondary rounded-0 w-100 mt-3">상품 문의하기</a>
