...
<div class="container w-50 mt-5 p-5 shadow">
    <form action="/user/userRegister" method="post" onsubmit="return submitChk()"> 
        ...
        <input class="form-control mb-2 w-50" type="text" name="user_pw" placeholder="비밀번호">
        <input class="form-control mb-2 w-50" type="text" name="user_nm" placeholder="이름">
        <input class="form-control mb-2 w-50" type="text" name="user_home" placeholder="집 번호">
        <input class="form-control mb-2 w-50" type="text" name="user_phone" placeholder="휴대폰 번호">
        <div class="row">
            <div class="col-md-8">
...
document.getElementById('birth_ymd').max = new Date().toISOString().substring(0, 10);; // 게시판 설정일 min 값을 오늘 날짜로
