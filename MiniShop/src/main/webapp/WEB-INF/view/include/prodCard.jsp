 ...
 <!-- 카드 시작 -->
 			<c:set var="cnt" value="${cnt+1 }"/> 
				<div id="prodImg" class="card rounded-0 border-0" style="width:400px; margin:20px">
				   ...
				   <a  href="/prodDetail/prodInfo?no=${dto.prod_no}"><img class="card-img-top rounded-0" src="<c:url value='/resources/upload/${dto.main_img}'/>"style="width:100%; height:300px"></a>
